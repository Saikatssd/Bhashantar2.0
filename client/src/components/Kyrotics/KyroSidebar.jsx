        ...
        {/* <div className='backdrop-blur-sm shadow-xl bg-white/30'> */}
            ...
            <img src={logo} alt="Logo" className="h-20 w-auto" />
                    ...
                    <ul className="mt-6 space-y-1">
                        ...
                        {role === 'admin' && (
                            <li>
                                <Link to={`/kyro/${companyId}/clientProjects`} className={`block rounded-lg px-4 py-4 text-sm font-medium ${isActive(`/kyro/${companyId}/clientProjects`) ? 'bg-[#e3d2fa] text-gray-700' : 'text-gray-500 hover:bg-[#e3d2fa] hover:text-gray-700'}`}>
                                    Go to Projects
                                </Link>
                            </li>
                        )}
