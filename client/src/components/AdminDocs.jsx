...
// const readyForWork = await fetchFileUsers(projectFiles.filter(file => {
//   console.log(`File ID: ${file.id}, Status: ${file.status}, Should be readyForWork: ${file.status === statusMapping.ready}`);
//   return file.status === statusMapping.ready;
// }));

// const inProgress = await fetchFileUsers(projectFiles.filter(file => {
//   console.log(`File ID: ${file.id}, Status: ${file.status}, Should be inProgress: ${file.status === statusMapping.progress}`);
//   return file.status === statusMapping.progress;
// }));

// const completed = await fetchFileUsers(projectFiles.filter(file => {
//   console.log(`File ID: ${file.id}, Status: ${file.status}, Should be completed: ${file.status === statusMapping.completed}`);
//   return file.status === statusMapping.completed;
// }));

// console.log('Ready for Work:', readyForWork);
