    ...
    <div>
      <div className={`flex flex-col justify-between transition-transform duration-300 ${isSidebarOpen ? 'translate-x-0' : '-translate-x-full'} md:translate-x-0 fixed md:relative w-64 h-full z-10`}>
        <div className="px-4 py-6">
          <ul className="mt-6 space-y-1">
            <li>
              <Link to='/home' className={`block rounded-lg px-4 py-2 text-sm font-medium ${isActive('/home') ? 'bg-[#e3d2fa] text-gray-700' : 'text-gray-500 hover:bg-[#e3d2fa] hover:text-gray-700'}`}>
                Home
              </Link>
            </li>
            <li>
              <Link to={`/company/${companyId}/profile`} className={`block rounded-lg px-4 py-2 text-sm font-medium ${isActive(`/company/${companyId}/profile`) ? 'bg-[#e3d2fa] text-gray-700' : 'text-gray-500 hover:bg-[#e3d2fa] hover:text-gray-700'}`}>
                Profile
              </Link>
            </li>
            {role !== 'user' && (
              <>
                <li>
                  <Link to={`/company/${companyId}/userManage`} className={`block rounded-lg px-4 py-2 text-sm font-medium ${isActive(`/company/${companyId}/userManage`) ? 'bg-[#e3d2fa] text-gray-700' : 'text-gray-500 hover:bg-[#e3d2fa] hover:text-gray-700'}`}>
                    Manage Users
                  </Link>
                </li>
                <li>
                  <Link to={`/company/${companyId}/roleManage`} className={`block rounded-lg px-4 py-2 text-sm font-medium ${isActive(`/company/${companyId}/roleManage`) ? 'bg-[#e3d2fa] text-gray-700' : 'text-gray-500 hover:bg-[#e3d2fa] hover:text-gray-700'}`}>
                    Manage Roles
                  </Link>
                </li>
                <li>
                  <Link to={`/company/${companyId}/permissionManage`} className={`block rounded-lg px-4 py-2 text-sm font-medium ${isActive(`/company/${companyId}/permissionManage`) ? 'bg-[#e3d2fa] text-gray-700' : 'text-gray-500 hover:bg-[#e3d2fa] hover:text-gray-700'}`}>
                    Manage Permissions
                  </Link>
                </li>
              </>
            ...
            <li>
              <Link to={`/company/${companyId}/project`} className={`block rounded-lg px-4 py-2 text-sm font-medium ${isActive(`/company/${companyId}/project`) ? 'bg-[#e3d2fa] text-gray-700' : 'text-gray-500 hover:bg-[#e3d2fa] hover:text-gray-700'}`}>
                Project
              </Link>
            </li>
            {role === 'user' && (
              <li>
                <Link to={`/company/${companyId}/mywork`} className={`block rounded-lg px-4 py-2 text-sm font-medium ${isActive(`/company/${companyId}/mywork`) ? 'bg-[#e3d2fa] text-gray-700' : 'text-gray-500 hover:bg-[#e3d2fa] hover:text-gray-700'}`}>
                  My Work
                </Link>
              </li>
            )}
            {role === 'superAdmin' && (
              <li>
                <Link to="/register" className={`block rounded-lg px-4 py-2 text-sm font-medium ${isActive('/register') ? 'bg-[#e3d2fa] text-gray-700' : 'text-gray-500 hover:bg-[#e3d2fa] hover:text-gray-700'}`}>
                  Register
                </Link>
              </li>
            )}
            {role !== 'user' && (
              <li>
                <Link to={`/company/${companyId}/uploadDocument`} className={`block rounded-lg px-4 py-2 text-sm font-medium ${isActive(`/company/${companyId}/uploadDocument`) ? 'bg-[#e3d2fa] text-gray-700' : 'text-gray-500 hover:bg-[#e3d2fa] hover:text-gray-700'}`}>
                  Upload Document
                </Link>
              </li>
            )}
