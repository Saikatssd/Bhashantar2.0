                ...
                <div className="px-4 py-6">
                    <ul className="mt-6 space-y-1">
                        <li>
                            ...
                            <Link to="#" className="block rounded-lg bg-[#e3d2fa] px-4 py-2 text-sm font-medium text-gray-700">
                                General
                            </Link>
                        </li>
                        <li>
                        ...
                        <li>
                            <Link to="/permissionManage" className="block rounded-lg px-4 py-2 text-sm font-medium text-gray-500 hover:bg-[#e3d2fa] hover:text-gray-700">
                                Manage Permissions
                            </Link>
                        </li>
                        <li>
                            <Link to="/project" className="block rounded-lg px-4 py-2 text-sm font-medium text-gray-500 hover:bg-[#e3d2fa] hover:text-gray-700">
                                Project
                            </Link>
                        </li>
                        <li>
